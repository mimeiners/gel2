...
![Schaltung für die Leistungsberechnung.](../images/hw/hw6p1){#fig-hw6p1 widht=400}
...
Wie groß ist $C_{opt}$ zu wählen für den Fall $R_2=90\,\Omega$, $R_i=10\,\Omega$, $L_i=20\,mH$, $\hat{U}_0=141\,V$ und
$\omega=2\pi 100\,Hz$ 
...
![Schaltung mit idealem Übertrager.](../images/hw/hw6p2){#fig-hw6p3 width=400}
...
![Impedanztransformation mimt einem idealen Übertrager.](../images/hw/hw6p2a){width=400}
...
![Ersatzschaltbild mit zusammengefassten Zweipolen.](../images/hw/hw6p2b){width=400}
