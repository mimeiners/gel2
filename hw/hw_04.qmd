...
In @fig-hw4p1a sind Betrag $\vert H_u \vert$ und Phase $\arg(H_u)$ der Spannungsübertragungsfunktion
von Tor 1 auf Tor 2, $\underline{H}_u=\underline{U}_2/\underline{U}_1$, abgebildet. 

![Bode-Diagramm des Zweitors](../images/hw/hw4p1a.pdf){#fig-hw4p1a width=600}
...
![Einfacher RC-Hochpass, Zweitor-Ersatzschaltbild](../images/hw/hw4p1b.png){#fig-hw4p1b width=400}
...
Konstruieren Sie eine Ortskurve der Admittanz $Y(\omega)$ für den skizzierten Zweipol in @fig-hw4p2.
...
![Zweipol-Admittanz](../images/hw/hw4p2.png){#fig-hw4p2 width=400}


## Ortskurve mit verschiedenen Parametern

Gegeben sei nachfolgende RLC-Schaltung in @fig-hw4p3.
Die Werte der Bauteile lauten $R_1 = 60\,\Omega$, $R_2 = 200\,\Omega$, $L = 200\,\mu H$ und $C = 5\,nF$. 

![RLC-Schaltung](../images/hw/hw4p3.png){#fig-hw4p3 width=400}
