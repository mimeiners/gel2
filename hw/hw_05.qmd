...
![Ersatzschaltbild des Versorgungsnetzes mit Verbraucher](../images/hw/hw5p11){#fig-hw5p11 width=400}
...
![Ersatzschaltbild des Versorgungsnetzes mit Verbraucher und zusätzlicher Kondensatorbatterie.](../images/hw/hw5p12){#fig-hw5p12 width=400}
...
mit folgendem Ersatzschaltbild @fig-hw5p2 eingesetzt.


![Ersatzschaltbild des Mittelfrequenzgenerators.](../images/hw/hw5p2){#fig-hw5p2 width=400}
...
\begin{align}
Z_G &= Z_V^*  \\
R_G + j \omega L_G &= \left( \frac{R_V}{1+j \omega C_K R_V} \right)^* \\
R_G &= \frac{R_V}{1 + (\omega C_K R_V)^2}  \\
L_G &= \frac{R_V^2 C_K}{1 + (\omega C_K R_V)^2} \\
R_V &= \frac{L_G}{C_K R_G} \\
\omega^2 &=\frac{1}{L_G C_K} - \frac{R_G^2}{L_G^2} \\
R_V &= 74,1\,k\Omega  \\
f &= 91,9\,kHz
\end{align}
:::
...
![Wien-Robinson-Brücke](../images/hw/hw5p3){#fig-hw5p3 width=400}
