...
Berechnen Sie den Frequenzgang der komplexen Amplitude $\underline{H}_u(f)=U_1(f)/U_0(f)$ der folgenden
Transformator-Schaltung eines dynamischen Mikrofons @fig-hw7p1.


![Ersatzschaltung eines dynamischen Mikrofons.](../images/hw/hw7p1.png){#fig-hw7p1 width=400}
...
![](../images/hw/hw7p1s.png){#fig-hw7p1s width=400}
...
![Ersatzschaltbild eines Lautsprechers.](../images/hw/hw7p2.png){#fig-hw7p2 width=400}
...
Für die exakte Berechnung $Z_E$ aus xxx einsetzen, genähert xxx benutzen.
