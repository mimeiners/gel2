...
C1: capacitor(down_ elen_); llabel( ,C_2, ); dot
line right dimen_ from C1.start; dot
R2: resistor(down_ elen_,,E); llabel( ,R_{2t}, ); dot
line right dimen_ from R2.start
C2: capacitor(down_ elen_); llabel( ,C_{2t}, )
