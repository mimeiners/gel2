...
\dpicdraw (1.5,-0.4)
 --(1.5,-0.75)\dpicstop
\draw (1.583333,-0.375) node[right=-2bp]{$ C_1$};
...
\dpicdraw (2.25,0)
 ...
 --(2.25,-0.541667)
 --(2.25,-0.75)\dpicstop
\draw (2.125,-0.833333) node{\mbox{ü}};
\dpicdraw (2.25,0)
 --(2.75,0)\dpicstop
\dpicdraw[fill=black](2.75,0) circle (0.007874in)\dpicstop
\dpicdraw (2.75,0)
 --(2.75,-0.25)\dpicstop
\dpicdraw (2.75,-0.5)
 --(2.8,-0.5)
...
\dpicdraw (2.75,-0.5)
 --(2.75,-0.75)\dpicstop
\draw (2.8,-0.375) node[right=-2bp]{$ R_2$};
\dpicdraw[fill=black](2.75,-0.75) circle (0.007874in)\dpicstop
\dpicdraw (2.75,0)
 --(3.25,0)\dpicstop
\dpicdraw (3.25,0)
 --(3.25,-0.35)\dpicstop
\dpicdraw (3.166667,-0.35)
 --(3.333333,-0.35)\dpicstop
\dpicdraw (3.166667,-0.4)
 --(3.333333,-0.4)\dpicstop
\dpicdraw (3.25,-0.4)
 --(3.25,-0.75)\dpicstop
\draw (3.333333,-0.375) node[right=-2bp]{$ C_2$};
\dpicdraw (3.25,-0.75)
 --(2.25,-0.75)\dpicstop
\end{tikzpicture}%
