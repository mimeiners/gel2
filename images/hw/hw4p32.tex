...
\filldraw[line width=0bp](-0.025,-0.59)
 --(0,-0.69)
 --(0.025,-0.59) --cycle\dpicstop
\dpicdraw (0,-0.06)
 --(0,-0.667094)\dpicstop
\draw (0,-0.375) node[left=-2bp]{$ \underline{V}_1$};
\dpicdraw (0,0)
 --(0.5,0)\dpicstop
\dpicdraw (0.5,0)
 --(0.85,0)\dpicstop
...
\dpicdraw (0.9,0)
 --(1.25,0)\dpicstop
\draw (0.875,0.083333) node[above=-2bp]{$ C$};
\dpicdraw (1.25,0)
 --(1.25,-0.25)\dpicstop
\dpicdraw (1.25,-0.5)
 --(1.3,-0.5)
...
\dpicdraw (1.25,-0.5)
 --(1.25,-0.75)\dpicstop
\draw (1.3,-0.375) node[right=-2bp]{$ R$};
\dpicdraw (1.25,0)
 --(1.75,0)\dpicstop
