...
\dpicdraw (0.5,0)
 --(0.5,-0.35)\dpicstop
\dpicdraw (0.416667,-0.35)
 --(0.583333,-0.35)\dpicstop
\dpicdraw (0.416667,-0.4)
 --(0.583333,-0.4)\dpicstop
\dpicdraw (0.5,-0.4)
 --(0.5,-0.75)\dpicstop
\draw (0.583333,-0.375) node[right=-2bp]{$ C_1$};
\dpicdraw (0.5,-0.75)
 --(0.5,-1)\dpicstop
\dpicdraw (0.5,-1.25)
 --(0.55,-1.25)
...
\dpicdraw (0.5,-1.25)
 --(0.5,-1.5)\dpicstop
\draw (0.45,-1.125) node[left=-2bp]{$ R_1$};
\dpicdraw (0.5,-0.75)
 --(1,-0.75)\dpicstop
...
\dpicdraw (1,-0.81)
 --(1,-1.417094)\dpicstop
\draw (1,-1.125) node[right=-2bp]{$ \underline{U}_2$};
\dpicdraw (1,-1.5)
 --(0,-1.5)\dpicstop
\end{tikzpicture}%
