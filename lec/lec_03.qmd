...
&= \frac{1}{2} \underbrace{\hat{x} e^{j \varphi}}_{Phasor} e^{j \omega t} 
+ \frac{1}{2} \underbrace{\hat{x} e^{-j\varphi}}_{Phasor} e^{-j \omega t} \\ 
...
&= \operatorname{Re}\left\{\hat{x}e^{j \varphi}e^{j \omega t}\right\} \\ 
&= \operatorname{Re}\left\{\hat{x}\left( \cos(\omega t + \varphi) + j \sin(\omega t + \varphi)\right)\right\}
\end{align}
:::
...
$$
\underline{x}(t) = \underline{\hat{x}} e^{j\omega t} = \hat{x} e^{j \varphi} e^{j \omega t}
$$
:::
...
$$
\underline{x}(0) = \underline{\hat{x}} = \hat{x} e^{j\varphi}
$$
:::
...
$$
\underline{x} = \frac{1}{\sqrt{2}} \hat{x} e^{j \varphi}
$$
:::
