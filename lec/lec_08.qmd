...
![$B(H)$-Hysteresekurve, Rayleigh-Schleife](../images/lec/lec8s1.pdf){#fig-lec8s1 width=400}
...
![(a) Zylinderspule, (b) Ringkernspule und \(c\) Drahtring](../images/lec/lec8s3.pdf){#fig-lec8s3 width=400}


![Gedruckte Spule (PCB)](../images/lec/lec8s4.pdf){#fig-lec8s4 width=200}
...
![Ersatzschaltung einer Spule.](../images/lec/lec8s2.pdf){#fig-lec8s2 width=400}
...
![Dämpfungsperle](../images/lec/lec8s5.pdf){#fig-lec8s5 width=400}
...
![Schaltnetzteil mit Drossel-Abwärtswandler](../images/lec/lec8s6.pdf){#fig-lec8s6 width=400}


#### Power Management Integrated Circuits (PMICs)

![PMICs](../images/lec/lec8sPMICs.pdf){#fig-lec8sPMICs width=400}
...
![Haupt- und Streuflüsse im Transformator](../images/lec/lec8s7.pdf){#fig-lec8s4 width=400}
...
![Schaltsymbol zweier gekoppelter Induktivitäten](../images/lec/lec8s8.pdf){#fig-lec8s8 width=400}
...
Übertrager](../images/lec/lec8s9.pdf){#fig-lec8s9 width=400}
...
![T-Ersatzschaltung](../images/lec/lec8s10.pdf){#fig-lec8s10 width=400}
...
![Ersatzschaltung eines unvollständig gekoppelten Übertragers](../images/lec/lec8s11.pdf){#fig-lec8s11 width=400}
...
Übertragers](../images/lec/lec8s12.pdf){#fig-lec8s12 width=400}


### Übertragungsfaktor

![Parallelersatzschaltung eines verlustbehafteten Übertragers mit beschaltetem
Ausgang](../images/lec/lec8s13.pdf){#fig-lec8s13 width=400}
...
![Zusammenfassung und Transformation der Sekundärseite](../images/lec/lec8s14.pdf){#fig-lec8s14 width=400}
