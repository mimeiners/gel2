...
![$B(H)$-Hysteresekurve, Rayleigh-Schleife](../images/lec/lec8s1){#fig-lec8s1 width=400}
...
![Gedruckte Spule (PCB)](../images/lec/lec8s4){#fig-lec8s4 width=200}
...
![Ersatzschaltung einer Spule.](../images/lec/lec8s2){#fig-lec8s2 width=400}
...
![Dämpfungsperle](../images/lec/lec8s5){#fig-lec8s5 width=400}
...
![Schaltnetzteil mit Drossel-Abwärtswandler](../images/lec/lec8s6){#fig-lec8s6 width=400}
...
![Haupt- und Streuflüsse im Transformator](../images/lec/lec8s7){#fig-lec8s4 width=400}
...
![Schaltsymbol zweier gekoppelter Induktivitäten](../images/lec/lec8s8){#fig-lec8s8 width=400}
...
Übertrager](../images/lec/lec8s9){#fig-lec8s9 width=400}
...
![T-Ersatzschaltung](../images/lec/lec8s10){#fig-lec8s10 width=400}
...
![Ersatzschaltung eines unvollständig gekoppelten Übertragers](../images/lec/lec8s11){#fig-lec8s11 width=400}
...
Übertragers](../images/lec/lec8s12){#fig-lec8s12 width=400}


### Übertragungsfaktor

![Parallelersatzschaltung eines verlustbehafteten Übertragers mit beschaltetem
Ausgang](../images/lec/lec8s13){#fig-lec8s13 width=400}
...
![Zusammenfassung und Transformation der Sekundärseite](../images/lec/lec8s14){#fig-lec8s14 width=400}
