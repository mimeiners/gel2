...
![Haupt- und Streuflüsse im Transformator](../images/lec/lec8s7){#fig-lec8s7}

Abbildung @fig-lec8s7 zeigt den prinzipiellen Aufbau eines Transformators bzw. Übertragers mit einer 
