...
![$f(t)$](../images/lec/lec5delay_func){#fig-delay_func}

![$\dot{f}(t)$](../images/lec/lec5delay_elmore){#fig-delay_elmore}
...
![RC-Schaltung für eine Ortskurve](../images/lec/lec5s2){#fig-lec5s2}
...
![Schematisches Bode-Diagramm](../images/lec/lec5rc_bode_schem){#fig-lec5rc_bode_schem}

**Übertragungsverhalten**

![RC-Tiefpass](../images/lec/lec5rc_tp){#fig-lec5rc_tp}
...
![Sprungantwort des RC-Tiefpasses](../images/lec/lec5rc_sprung){#fig-lec5rc_sprung}
...
![RC-Hochpass](../images/lec/lec5rc_hp){#fig-lec5rc_hp}

![Schematisches Bode-Diagramm](../images/lec/lec5rc_hp_bode_schem){#fig-lec5rc_hp_bode_schem}
...
![Sprungantwort des RC-Hochpasses](../images/lec/lec5rc_hp_sprung){#fig-lec5rc_hp_sprung}
...
![Bode-Diagramm eines Bandpasses](../images/lec/lec5bp){#fig-lec5bp}
...
<!-- ![Tabelle der Elementtransformationen TP zu HP, zu BP und zu BS](../images/lec/lec5ElemTransf){#fig-lec5ElemTransf} -->
...
![Wien-Robinson-Brücke](../images/lec/lec5wien-robinson){#fig-wien-robinson}

"Brücken mit frequenzabhängigem Abgleich, wie die Wien-Robinson-Brücke in @fig-wien-robinson, können als einfache
Frequenzmessgeräte genutzt werden. Die Abgleichbedingungen der Wien-Robinson-Brücke lauten

$$
\frac{C_4}{C_3} = \frac{R_1}{R_2} - \frac{R_3}{R_4}
$$ {#eq-wien-robinson1}

$$
\frac{C_3}{C_4} = \frac{1}{\omega^2 R_3 R_4}.
$$ {#eq-wien-robinson2}

Häufig wählt man $R_2=R_3=R_4=R$, $R_1=2R$ und $C_3=C_4=C$. Damit ist @eq-wien-robinson1 automatisch erfüllt, während
@eq-wien-robinson2 eine neue Abgleichbedingung ergibt, aus der die Frequenz $\omega$ der Brückeneingangsspannung
