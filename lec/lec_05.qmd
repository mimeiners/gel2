...
Frequenz bewirkt er eine Abschwächung und eine Phasenvorauseilung. Abbildung @fig-  zeigt schematisch den Verlauf von 
$a_v$ im Bode-Diagramm für einen Hochpaß. In dem bei tiefen Frequenzen vorliegenden Sperrbereich erfolgt bei
Hochpaßnetzwerken aus linearen Elementen ein Anstieg mit einem Vielfachen von 20 dB/dec entsprechend der Ordnung des
...
Phasenverschiebung zwischen Eingangs- und Ausgangssignal, die bei kleinen Frequenzen 90$ˆ{\circ}$ beträgt, wird nun zu
...
Abbildung 1.19 zeigt für beide Situationen den Verlauf der Spannung an Eingang und Ausgang. Als charakteristische Zeit
...
\begin{case}
150\,mV \quad \text{bei steigender Flanke} \\\
−150 \,mV \quad \text{bei fallender Flanke.}
\end{case}
$$
